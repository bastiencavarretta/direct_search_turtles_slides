    ...
    \begin{columns}[c]
        ...
        \begin{column}{0.3\textwidth}
            ...
            \begin{block}{\centering Bastien}
                \vspace{0.4em}
                \begin{center}
                    \includegraphics[width=4.5cm,angle = 270]{images/bastien.jpeg}
                \end{center}
                \begin{itemize}
                    \item 2ème année
                    \item Optimisation
        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \only<2->{\addplot[mark=*, mark size=  4pt, color=MediumRed]
                    coordinates {(200, 0.4)}
                    node[above, font=\small, color=MediumRed] {minimum !};}
                \end{axis}
            \end{tikzpicture}
        \end{column}
...
\begin{frame}{Où est le minimum ? (2/2)}
    ...
    \begin{columns}[c]
        \begin{column}{0.5\textwidth}
            \begin{tikzpicture}
                \only<1-2>{\input{tikz_files/minloc.tex}}
                \only<3>{\input{tikz_files/minloc-minglob.tex}}
            \end{tikzpicture}
...
\centering
                ...
                \addplot[mark=*, mark size=  4pt, color=MediumRed]
                    ...
                    node[above right, font=\small, color=MediumRed] {maximum !};}
    ...
    \begin{columns}[c]
        \begin{column}{0.55\textwidth}
            \begin{figure}
                ...
                \caption*{Plusieur paramètres (latitude \& longitude)}
            \end{figure}
        \end{column}
...
\begin{frame}{L'intuition : suivre la pente}
    \begin{columns}[c]
        ...
        \begin{column}{0.47\textwidth}
            \centering
            \begin{tikzpicture}
            \only<1-4>{\input{tikz_files/balle}}
            % \only<5->{\input{tikz_files/balle2}}
            \end{tikzpicture}
        \end{column}
    \end{columns}
\end{frame}
